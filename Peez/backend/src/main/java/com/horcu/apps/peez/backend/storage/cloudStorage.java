package com.horcu.apps.peez.backend.storage;//[START all]
/*
...
public class cloudStorage {
     ...
     */
    private static final String APPLICATION_NAME = "Ballrz";
    ...
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: Ballrz buckets <bucket-name>");
            System.exit(1);
        }
