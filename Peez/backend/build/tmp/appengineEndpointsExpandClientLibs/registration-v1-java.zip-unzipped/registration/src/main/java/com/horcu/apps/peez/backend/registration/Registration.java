 ...
 * on 2016-03-26 at 18:33:59 UTC 
 * Modify at your own risk.
 */

package com.horcu.apps.peez.backend.registration;
...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ListDevices extends RegistrationRequest<com.horcu.apps.peez.backend.registration.model.CollectionResponseRegistrationRecord> {
    ...
    protected ListDevices(java.lang.Integer count) {
      super(Registration.this, "GET", REST_PATH, null, com.horcu.apps.peez.backend.registration.model.CollectionResponseRegistrationRecord.class);
   ...
   * @return the request
   */
  public Register register(java.lang.String regId, java.lang.String userEmail) throws java.io.IOException {
    Register result = new Register(regId, userEmail);
    initialize(result);
    return result;
  }
  ...
  public class Register extends RegistrationRequest<Void> {
    ...
    private static final String REST_PATH = "registerDevice/{regId}/{userEmail}";
     ...
     * @since 1.13
     */
    protected Register(java.lang.String regId, java.lang.String userEmail) {
    ...
    public Register setUserEmail(java.lang.String userEmail) {
