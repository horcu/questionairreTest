...
public class UserApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public Patch patch(java.lang.String name, com.horcu.apps.peez.backend.models.userApi.model.User content) throws java.io.IOException {
  ...
  public class Patch extends UserApiRequest<com.horcu.apps.peez.backend.models.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Patch(java.lang.String name, com.horcu.apps.peez.backend.models.userApi.model.User content) {
   ...
   * @return the request
   */
  public Update update(java.lang.String name, com.horcu.apps.peez.backend.models.userApi.model.User content) throws java.io.IOException {
  ...
  public class Update extends UserApiRequest<com.horcu.apps.peez.backend.models.userApi.model.User> {
     ...
     * @since 1.13
     */
    protected Update(java.lang.String name, com.horcu.apps.peez.backend.models.userApi.model.User content) {
