 ...
 * on 2016-03-23 at 13:52:58 UTC 
 * Modify at your own risk.
 */

package com.horcu.apps.peez.backend.models.playerApi;
...
public class PlayerApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  static {
    com.google.api.client.util.Preconditions.checkState(
        ...
        "1.21.0 of the playerApi library.", com.google.api.client.googleapis.GoogleUtils.VERSION);
  }
  ...
  public class Get extends PlayerApiRequest<com.horcu.apps.peez.backend.models.playerApi.model.Player> {
    ...
    protected Get(java.lang.String email) {
      super(PlayerApi.this, "GET", REST_PATH, null, com.horcu.apps.peez.backend.models.playerApi.model.Player.class);
   ...
   *
   * @param content the {@link com.horcu.apps.peez.backend.models.playerApi.model.Player}
   * @return the request
   */
  public Insert insert(com.horcu.apps.peez.backend.models.playerApi.model.Player content) throws java.io.IOException {
    Insert result = new Insert(content);
    initialize(result);
    return result;
  }

  public class Insert extends PlayerApiRequest<com.horcu.apps.peez.backend.models.playerApi.model.Player> {
     ...
     * @since 1.13
     */
    protected Insert(com.horcu.apps.peez.backend.models.playerApi.model.Player content) {
      super(PlayerApi.this, "POST", REST_PATH, content, com.horcu.apps.peez.backend.models.playerApi.model.Player.class);
    }
  ...
  public class List extends PlayerApiRequest<com.horcu.apps.peez.backend.models.playerApi.model.CollectionResponsePlayer> {
     ...
     */
    protected List() {
      super(PlayerApi.this, "GET", REST_PATH, null, com.horcu.apps.peez.backend.models.playerApi.model.CollectionResponsePlayer.class);
    }
   ...
   * @return the request
   */
  public Patch patch(java.lang.String email, com.horcu.apps.peez.backend.models.playerApi.model.Player content) throws java.io.IOException {
    Patch result = new Patch(email, content);
    initialize(result);
    return result;
  }

  public class Patch extends PlayerApiRequest<com.horcu.apps.peez.backend.models.playerApi.model.Player> {
     ...
     * @since 1.13
     */
    protected Patch(java.lang.String email, com.horcu.apps.peez.backend.models.playerApi.model.Player content) {
      super(PlayerApi.this, "PATCH", REST_PATH, content, com.horcu.apps.peez.backend.models.playerApi.model.Player.class);
      this.email = com.google.api.client.util.Preconditions.checkNotNull(email, "Required parameter email must be specified.");
    }
   ...
   * @return the request
   */
  public Update update(java.lang.String email, com.horcu.apps.peez.backend.models.playerApi.model.Player content) throws java.io.IOException {
    Update result = new Update(email, content);
    initialize(result);
    return result;
  }

  public class Update extends PlayerApiRequest<com.horcu.apps.peez.backend.models.playerApi.model.Player> {
     ...
     * @since 1.13
     */
    protected Update(java.lang.String email, com.horcu.apps.peez.backend.models.playerApi.model.Player content) {
      super(PlayerApi.this, "PUT", REST_PATH, content, com.horcu.apps.peez.backend.models.playerApi.model.Player.class);
      this.email = com.google.api.client.util.Preconditions.checkNotNull(email, "Required parameter email must be specified.");
    }
