...
import com.horcu.apps.peez.misc.DeviceGroup;
import com.horcu.apps.peez.misc.Sender;
...
import static com.horcu.apps.peez.gcm.HttpRequest.CONTENT_TYPE_JSON;
import static com.horcu.apps.peez.gcm.HttpRequest.HEADER_AUTHORIZATION;
import static com.horcu.apps.peez.gcm.HttpRequest.HEADER_CONTENT_TYPE;
import static com.horcu.apps.peez.gcm.HttpRequest.HEADER_PROJECT_ID;
    ...
    public void asyncCreateGroup(final View snackbarView, final String senderId, final String apiKey,
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                try {
                    com.horcu.apps.peez.gcm.HttpRequest httpRequest = new com.horcu.apps.peez.gcm.HttpRequest();
