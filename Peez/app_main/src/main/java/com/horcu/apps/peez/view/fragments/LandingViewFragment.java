...
import com.horcu.apps.peez.databinding.FragmentLandingViewBinding;
...
public class LandingViewFragment extends Fragment {
    FragmentLandingViewBinding binding;
    ...
    public LandingViewFragment() {
        // Required empty public constructor
    }

    public static LandingViewFragment newInstance() {
        LandingViewFragment fragment = new LandingViewFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLandingViewBinding.inflate(inflater, container, false);
...
//               }
    ...
    public interface OnFragmentInteractionListener {
        ...
        void onNonGameChat(PlayerViewModel playerVm);
    }
