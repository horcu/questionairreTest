 ...
 */
package com.horcu.apps.peez.gcm.message;
...
public  class Message extends RealmObject implements Serializable {
    ...
    public static final class Builder {
        ...
        /**
         * Sets the img property.
         */
        public Builder SenderImageUrl(String value) {
            SenderImageUrl = value;
            return this;
        }
     ...
     * Gets the sender image url.
     */
    public void setSenderImageUrl(String url) {
     ...
     * Gets the collapse key.
     */
    public void setCollapseKey(String colKey) {
         this.collapseKey = colKey;
    }
     ...
     * Gets the delayWhileIdle flag.
     */
    public void setDelayWhileIdle(Boolean dwi) {
        this.delayWhileIdle = dwi;
    }
     ...
     * Gets the restricted package name.
     */
    public void setRestrictedPackageName(String pn) {
        this.restrictedPackageName = pn;
    }
     ...
     * Gets the notification params, which are immutable.
     */
    public void setNotificationParams(Map<String, String> params) {
...
//    public void appendMap(StringBuilder builder, String name, Map<String, String> map) {
//        if (!map.isEmpty()) {
