 ...
 */
package com.horcu.apps.peez.gcm.core;
...
public class GcmServerSideSender {
    ...
    public void sendHttpPlaintextDownstreamMessage(String destination, Message message)
        ...
        addOptParameter(request, PARAM_DELAY_WHILE_IDLE, message.getDelayWhileIdle());
        addOptParameter(request, PARAM_DRY_RUN, message.getDryRun());
     ...
     * @throws IOException
     */
    public String sendHttpJsonDownstreamMessage(Message message) throws IOException {

        JSONObject jsonBody = new JSONObject();
        try {
            jsonBody.put(PARAM_TO, message.getTo());
            ...
            jsonBody.putOpt(PARAM_DELAY_WHILE_IDLE, message.getDelayWhileIdle());
            jsonBody.putOpt(PARAM_DRY_RUN, message.getDryRun());
