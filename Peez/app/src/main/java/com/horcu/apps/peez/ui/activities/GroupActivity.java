...
public class GroupActivity extends AppCompatActivity
    ...
    private void submitApplyChanges() {
        ...
        mDeviceGroupsHelper.asyncUpdateGroup(newMembersView, sender.senderId, senderApiKey,
                ...
                .setPositiveButton(R.string.group_alert_delete_group,
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                mDeviceGroupsHelper.asyncDeleteGroup(newMembersView, sender.senderId, senderApiKey,
    ...
    private void submitCreateGroup() {
        ...
        mDeviceGroupsHelper.asyncCreateGroup(newMembersView, sender.senderId, senderApiKey,
