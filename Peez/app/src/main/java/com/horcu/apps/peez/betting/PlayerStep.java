package com.horcu.apps.peez.betting;
...
public class PlayerStep extends Step {
    ...
    public PlayerStep(Context context, String dataKey, int inputType, int titleResId, int errorResId, int detailsResId, StepChecker checker, TextView.OnEditorActionListener l) {
    ...
    public PlayerStep(Context context, String dataKey, int inputType, int titleResId, int errorResId, int detailsResId, TextView.OnEditorActionListener l) {
    ...
    public PlayerStep(Context context, String dataKey, int inputType, int titleResId, int errorResId, int detailsResId, StepChecker checker) {
        this(context, dataKey, inputType, titleResId, errorResId, detailsResId, checker, null);
    }

    public PlayerStep(Context context, String dataKey, int inputType, int titleResId, int errorResId, int detailsResId) {
        this(context, dataKey, inputType, titleResId, errorResId, detailsResId, new StepChecker() {
            @Override
            public boolean check(String input) {
                return true;
    ...
    public PlayerStep(Context context, String dataKey, int inputType, String title, String error, String details, StepChecker checker, TextView.OnEditorActionListener l) {
    ...
    public PlayerStep(Context context, String dataKey, int inputType, String title, String error, String details, TextView.OnEditorActionListener l) {
    ...
    public PlayerStep(Context context, String dataKey, int inputType, String title, String error, String details, StepChecker checker) {
        this(context, dataKey, inputType, title, error, details, checker, null);
    }

    public PlayerStep(Context context, String dataKey, int inputType, String title, String error, String details) {
        this(context, dataKey, inputType, title, error, details, new StepChecker() {
            @Override
            public boolean check(String input) {
                return true;
