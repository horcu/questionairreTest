...
/**
 * Created by Horatio on 3/26/2016.
 */
...
public class MaterialLetterIcon extends View {
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        TypedArray attr = getTypedArray(context, attributeSet, com.example.ivbaranov.ma.R.styleable.MaterialLetterIcon);
        if (attr != null) {
            try {
                mShapeColor =
                        attr.getColor(com.example.ivbaranov.ma.R.styleable.MaterialLetterIcon_mli_shape_color, DEFAULT_SHAPE_COLOR);
                mInitials =
                        attr.getBoolean(com.example.ivbaranov.ma.R.styleable.MaterialLetterIcon_mli_initials, DEFAULT_INITIALS_STATE);
                mInitialsNumber = attr.getInt(com.example.ivbaranov.ma.R.styleable.MaterialLetterIcon_mli_initials_number,
                        DEFAULT_INITIALS_NUMBER);
                mOriginalLetter = attr.getString(com.example.ivbaranov.ma.R.styleable.MaterialLetterIcon_mli_letter);
                if (mOriginalLetter != null) {
                    setLetter(mOriginalLetter);
                }
                mShapeType = attr.getInt(com.example.ivbaranov.ma.R.styleable.MaterialLetterIcon_mli_shape_type, DEFAULT_SHAPE);
                mLetterColor =
                        attr.getColor(com.example.ivbaranov.ma.R.styleable.MaterialLetterIcon_mli_letter_color, DEFAULT_LETTER_COLOR);
                mLetterSize =
                        attr.getInt(com.example.ivbaranov.ma.R.styleable.MaterialLetterIcon_mli_letter_size, DEFAULT_LETTER_SIZE);
                mLettersNumber =
                        attr.getInt(com.example.ivbaranov.ma.R.styleable.MaterialLetterIcon_mli_letters_number, DEFAULT_LETTERS_NUMBER);
            } finally {
                attr.recycle();
            }
        }
